...
#         # login.get_main_page()
#         self.driver.get(getToken.main_url)
...
#         }
#         s = requests.Session()
#         s.get(getToken.signin_url)
#         s.post(getToken.signin_url, data=LOGIN_INFO)
#         self.driver.get(getToken.signin_url)
#         for c in s.cookies:
#             self.driver.add_cookie({'name': c.name, 'value': c.value, 'path': c.path, 'expiry': c.expires})
#         self.driver.refresh()
